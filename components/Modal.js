                ...
                <div className="flex items-start justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        <div className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
                            <div className="flex items-center justify-end px-1.5 py-2 border-b border-[#EFF3F4]-700">
                            ...
                            <div className="flex px-4 pt-5 pb-2.5 sm:px-6">
                                <div className="w-full">
                                    <div className="text-[#333] flex gap-x-3 relative">
                                        <span className="w-0.5 h-full z-[-1] absolute left-5 top-11 bg-[#CFD9DE]" />
                                        <img src={post?.userImg} alt="" className="h-11 w-11 rounded-full" />
                                        <div>
                                            <div className="inline-block group">
                                                <h4 className="font-bold text-[#333] inline-block text-[15px] sm:text-base">
                                                {post?.username}
                                                </h4>
                                            ...
                                            <p className="text-[#333] text-[15px] sm:text-base">
                                                {post?.text}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-7 flex space-x-3 w-full">
                                        ...
                                        <div className="flex-grow mt-2">
                                            <textarea 
                                                ...
                                                rows="2"
                                                className="bg-transparent outline-none text-[#333] text-lg placeholder-gray-500 tracking-wide w-full min-h-[80px]"
                                            />
